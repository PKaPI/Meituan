...
var dd1Switch = document.getElementById('dd1-switch');
var dd1Content = document.getElementById('dd1-content');
var dd1Link = document.getElementById('dd1-link');

console.log(dd1Switch,dd1Content);


dd1Switch.onmouseover = function(){
    dd1Content.style.display = "block";
    addClass(dd1Link,'dropdown-hover');
}

dd1Switch.onmouseout = function(){
    dd1Content.style.display = "none";
    removeClass(dd1Link,'dropdown-hover');
}


//导航菜单
var navLvl11 = document.getElementById('nav-level1-1');
var navLvl21 = document.getElementById('nav-level2-1');

navLvl11.onmouseover = function(){
    navLvl21.style.display = "block";
